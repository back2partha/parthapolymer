...
attached:function(){},detached:function(){}};var ironFormElementBehavior={IronFormElementBehavior:IronFormElementBehavior};Polymer({_template:html`
    <style>
      :host {
        display: block;
      }
...
if(value===void 0&&this.value!==void 0)this.invalid=!this._getValidity(this.value);else this.invalid=!this._getValidity(value);return!this.invalid},/**
   ...
   * @return {boolean} True if `value` is valid.
   */_getValidity:function(value){if(this.hasValidator()){return this._validator.validate(value)}return!0}};var ironValidatableBehavior={get IronValidatableBehaviorMeta(){return IronValidatableBehaviorMeta},IronValidatableBehavior:IronValidatableBehavior};Polymer({_template:html`
    <style>
      :host {
        display: inline-block;
      }
...
</custom-style>`;template$6.setAttribute("style","display: none;");document.head.appendChild(template$6.content);Polymer({is:"paper-icon-button",_template:html`
    <style>
      :host {
        display: inline-block;
        position: relative;
...
this._focusableElement.focus()}}}},PaperInputBehavior=[IronControlState,IronA11yKeysBehavior,PaperInputBehaviorImpl];var paperInputBehavior={PaperInputHelper:PaperInputHelper,PaperInputBehaviorImpl:PaperInputBehaviorImpl,PaperInputBehavior:PaperInputBehavior};const template$7=html`<custom-style>
  <style is="custom-style">
    html {
...
</custom-style>`;template$7.setAttribute("style","display: none;");document.head.appendChild(template$7.content);Polymer({/** @override */_template:html`
    <style>
      :host {
        display: inline-block;
        float: right;
...
if(!!this.inputElement.bindValue){this.$.container._handleValueAndAutoValidate(this.inputElement)}}});const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<iron-iconset-svg name="my-icons" size="24">
  <svg>
    <defs>
      <g id="arrow-back">
...
setRootPath(MyAppGlobals.rootPath);class MyApp extends PolymerElement{static get template(){return html`
      ...
      /* app-drawer styles */
        ...
        app-header {
          color: #fff; background-color: var(--app-primary-color);
        }
        ...
        .drawer-list a {
          display: block; padding: 0 46px; text-decoration: none; color: var(--app-secondary-color); line-height: 40px;font-size:12px;
        }
      ...
      <!-- initiates app location -->
      <app-location route="{{route}}" url-space-regex="^[[rootPath]]"></app-location>
      

      <!-- this element matches the current route via pattern for data-->
      ...
      <app-drawer-layout fullbleed="" narrow="{{narrow}}">
        ...
        <app-drawer id="drawer" slot="drawer" swipe-open="[[narrow]]">
          <app-toolbar><img src="/images/logo.png" width="100%"/></app-toolbar>
          <div style="font-size:10px; line-height:30px; padding:60px; text-align:center;">Inpatient care means you are admitted to the hospital on a doctor's order. ... Outpatient care is defined as hospital or medical facility care that you receive without being admitted or for a stay of less than 24 hours (even if this stay occurs overnight).</div>
          
              <!-- listens the event and update selection state -->
            ...
            <!-- toggle and header -->
              <app-header slot="header" condenses="" reveals="" effects="waterfall">
                <app-toolbar>
                  ...
                  <div style="font-size:14px;">Healthcare management</div>
                </app-toolbar>
              </app-header>

              <!-- routing elements -->
              <iron-pages selected="[[page]]" attr-for-selected="name" role="main">
                <my-staff name="mystaff"></my-staff>
                <emergency-contact name="emergencycontact"></emergency-contact>
                <my-login name="login"></my-login>
                <my-registerhome name="registerhome"></my-registerhome>
                <my-register name="register"></my-register>
                <my-view404 name="view404"></my-view404>
              </iron-pages>
        </app-header-layout>
      </app-drawer-layout>
    `}static get properties(){return{page:{type:String,reflectToAttribute:!0,observer:"_pageChanged"},routeData:Object,subroute:Object}}static get observers(){return["_routePageChanged(routeData.page)"]}_routePageChanged(page){// Show the corresponding page according to the route. passing values
//
// If no page was found in the route data, page will be an empty string.
// Show 'login' in that case. And if the page doesn't exist, show 'view404'.
if(!page){this.page="login"}else if(-1!==["login","mystaff","emergencycontact","registerhome","register"].indexOf(page)){this.page=page}else{this.page="view404"}// Close a non-persistent drawer when the page & route are changed.
if(!this.$.drawer.persistent){this.$.drawer.close()}}_pageChanged(page){// Import the page component on demand.
//
// Note: `polymer build` doesn't like string concatenation in the import
// statement, so break it up.
switch(page){case"login":import("./my-login.js").then(bundle=>bundle&&bundle.$myLogin||{});break;case"mystaff":import("./my-staff.js").then(bundle=>bundle&&bundle.$myStaff||{});break;case"emergencycontact":import("./emergency-contact.js").then(bundle=>bundle&&bundle.$emergencyContact||{});break;case"registerhome":import("./my-registerhome.js").then(bundle=>bundle&&bundle.$myRegisterhome||{});break;case"register":import("./my-register.js").then(bundle=>bundle&&bundle.$myRegister||{});break;case"view404":import("./my-view404.js").then(bundle=>bundle&&bundle.$myView404||{});break;}}}window.customElements.define("my-app",MyApp);const $_documentContainer$1=document.createElement("template");$_documentContainer$1.innerHTML=`<dom-module id="shared-styles">
  <template>
    <style>
    ...
    p{
      ...
      .subnav{
        background-color:#cccccc; color:#666666; text-decoration:none; padding:5px;
      }
      ...
      .iotablelist{
        background-color:#275B66; padding:60px; color:#999999; margin:25px; border-radius:6px;
      }
      ...
      @media (max-width: 400px) {
         ...
         .iotablelist{
          background-color:#275B66; padding:10px; color:#999999; margin:5px; border-radius:6px;
