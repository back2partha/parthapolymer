...
switch(page){case"login":new Promise((res,rej)=>_require.default(["./my-login.js"],res,rej)).then(bundle=>bundle&&bundle.$myLogin||{});break;case"mystaff":new Promise((res,rej)=>_require.default(["./my-staff.js"],res,rej)).then(bundle=>bundle&&bundle.$myStaff||{});break;case"emergencycontact":new Promise((res,rej)=>_require.default(["./emergency-contact.js"],res,rej)).then(bundle=>bundle&&bundle.$emergencyContact||{});break;case"registerhome":new Promise((res,rej)=>_require.default(["./my-registerhome.js"],res,rej)).then(bundle=>bundle&&bundle.$myRegisterhome||{});break;case"register":new Promise((res,rej)=>_require.default(["./my-register.js"],res,rej)).then(bundle=>bundle&&bundle.$myRegister||{});break;case"view404":new Promise((res,rej)=>_require.default(["./my-view404.js"],res,rej)).then(bundle=>bundle&&bundle.$myView404||{});break;}}}window.customElements.define("my-app",MyApp);const $_documentContainer$1=document.createElement("template");$_documentContainer$1.innerHTML=`<dom-module id="shared-styles">
  <template>
    <style>
